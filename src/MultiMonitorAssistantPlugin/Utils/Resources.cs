namespace Loupedeck.MultiMonitorAssistantPlugin {
  ...
  internal static class Resources {
    ...
    // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MultiMonitorAssistantPlugin.Resources`.
    // Returns the full names of the resource files, for example, `Loupedeck.MultiMonitorAssistantPlugin.Resources.Resource.txt`.
    ...
    public static void ExtractFile(String resourceName, String filePathName) => _assembly.ExtractFile(FindFile(resourceName), filePathName);
  }
}
